      ...
      <section className="py-12 md:py-20" style={{ backgroundColor: "#111827" }}>
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {whyItems.map((item) => (
              <div key={item.title} className="rounded-2xl p-6 text-center" style={{ backgroundColor: "#1F2937", border: "1px solid #374151" }}>
      ...
      <section className="py-12 md:py-20" style={{ backgroundColor: "#DC2626" }}>
        <div className="max-w-7xl mx-auto px-4 md:px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="mailto:office@baktransport.at" className="inline-block px-8 py-4 rounded-xl font-semibold text-base" style={{ backgroundColor: "#FFFFFF", color: "#DC2626" }}>{t.karriere_cta_btn1}</a>
            <a href="tel:+436761234567" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl font-semibold text-base text-white" style={{ border: "2px solid rgba(255,255,255,0.6)" }}><Phone className="w-5 h-5" />{t.karriere_cta_btn2}</a>
          </div>
        </div>
      </section>
    </PageLayout>
