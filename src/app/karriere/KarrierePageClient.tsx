      ...
      <section className="py-12 md:py-20" style={{ backgroundColor: "#C2410C" }}>
        <div className="max-w-7xl mx-auto px-4 md:px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="tel:+4368110723047" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl font-semibold text-base" style={{ border: "2px solid #C2410C", color: "#C2410C" }}><Phone className="w-5 h-5" />{t.karriere_cta_btn2}</a>
          </div>
        </div>
      </section>
    </PageLayout>
