...
export function PrivatumzugPageClient() {
  ...
  return (
    <PageLayout label={t.priv_page_label} title={t.priv_page_title} subtitle={t.priv_page_subtitle}>
      ...
      <section className="py-12 md:py-20" style={{ backgroundColor: "#F9FAFB" }}>
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-4 text-gray-900">{t.priv_page_price_h2}</h2>
          <p className="text-center mb-12" style={{ color: "#6B7280" }}>{t.priv_page_price_footnote}</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricing.map((p) => (
