  ...
  return (
    <PageLayout label={t.grenz_page_label} title={t.grenz_page_title} subtitle={t.grenz_page_subtitle}>
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold mb-6" style={{ color: "#111827" }}>{t.grenz_page_h2}</h2>
      ...
      <section className="py-12 md:py-20" style={{ backgroundColor: "#111827" }}>
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-4 text-white">{t.grenz_page_price_h2}</h2>
          <p className="text-center mb-12" style={{ color: "#9CA3AF" }}>{t.grenz_page_price_footnote}</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricing.map((p) => (
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          <h2 className="text-2xl md:text-3xl font-bold mb-10 md:mb-12" style={{ color: "#111827" }}>{t.grenz_page_faq_h2}</h2>
