...
export function WienPageClient() {
  ...
  return (
    <PageLayout label={t.wien_page_label} title={t.wien_page_title} subtitle={t.wien_page_subtitle}>
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            <div>
              <h2 className="text-2xl md:text-3xl font-bold mb-6" style={{ color: "#F9FAFB" }}>{t.wien_page_h2}</h2>
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <h2 className="text-2xl md:text-3xl font-bold mb-6" style={{ color: "#F9FAFB" }}>{t.wien_page_districts_h2}</h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
            {bezirke.map((bezirk) => (
              <div key={bezirk} className="rounded-lg px-3 py-2 text-sm font-medium text-center"
                style={{ backgroundColor: "#F9FAFB", border: "1px solid #E5E7EB", color: "#E5E7EB" }}>
                {bezirk}
              </div>
            ))}
          </div>
      ...
      <section className="py-12 md:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 md:px-6">
          <h2 className="text-2xl md:text-3xl font-bold mb-10 md:mb-12" style={{ color: "#F9FAFB" }}>{t.wien_page_faq_h2}</h2>
