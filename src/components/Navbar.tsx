    ...
    >
      <div ref={navRef} className="max-w-7xl mx-auto pl-0 pr-2 md:px-6 h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <Phone size={17} />
            <span className="hidden md:inline" style={{ fontSize: "14px", whiteSpace: "nowrap" }}>{lang === "en" ? "Call Us" : "Anrufen"}</span>
          </a>
          ...
          >
            ...
            <span className="hidden md:inline" style={{ fontSize: "14px", whiteSpace: "nowrap" }}>WhatsApp</span>
          </a>
