...
const de = {
  ...
  kontakt_map_h2: "So finden Sie uns",
  ...
  datenschutz_responsible_a:
    "Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber: BAK Transport, Zwinzstraße 15-21, 1160 Wien, office@baktransport.at",
  ...
  datenschutz_contact:
    "BAK Transport · Zwinzstraße 15-21, 1160 Wien · office@baktransport.at · +43 681 10723047",
  ...
  agb_p1:
    "Diese Allgemeinen Geschäftsbedingungen (AGB) gelten für alle Verträge zwischen BAK Transport, Zwinzstraße 15-21, 1160 Wien (nachfolgend „BAK Transport“) und ihren Kunden über Umzugs-, Transport-, Möbel- und Küchenmontage- sowie Entrümpelungsleistungen. Abweichende Bedingungen des Kunden werden nicht anerkannt, es sei denn, BAK Transport stimmt ihrer Geltung ausdrücklich schriftlich zu.",
  ...
  // Bezirk
  bezirk_wien: "Wien",
  bezirk_label_prefix: "Umzug",
  bezirk_subtitle_prefix: "Ihr professioneller Umzugspartner im",
  bezirk_subtitle_suffix: "— Fixpreis, vollversichert, zuverlässig.",
  bezirk_intro_h2_prefix: "Professioneller Umzugsservice im",
  bezirk_intro_p2:
  ...
  bezirk_checklist_3: "Schutzdecken & Verpackungsmaterial",
  bezirk_checklist_4: "Möbeldemontage & Montage auf Wunsch",
  bezirk_checklist_5: "Halteverbotsorganisation",
  bezirk_checklist_6: "Vollständige Haftpflichtversicherung",
  bezirk_checklist_7: "Kostenlose Vorab-Besichtigung",
  bezirk_checklist_8: "Verbindlicher Fixpreis – keine Überraschungen",
  bezirk_pricing_h2_prefix: "Umzugspreise für",
  bezirk_pricing_subtitle:
    "Fixpreise ab Besichtigung — keine Stundenlohn-Falle, keine versteckten Kosten.",
  bezirk_price1_label: "Klein",
  bezirk_price1_size: "bis 50 m²",
  bezirk_price1_price: "ab €650",
  bezirk_price1_detail: "1–2 Zimmer, inkl. 2 Mann & LKW",
  bezirk_price2_label: "Kompakt",
  bezirk_price2_size: "50–90 m²",
  bezirk_price2_price: "ab €950",
  bezirk_price2_detail: "2–3 Zimmer, inkl. 3 Mann & LKW",
  bezirk_price3_label: "Groß",
  bezirk_price3_size: "über 90 m²",
  bezirk_price3_price: "ab €1.490",
  bezirk_price3_detail: "4+ Zimmer, inkl. 4 Mann & LKW",
  bezirk_pricing_cta_btn: "Jetzt Fixpreis anfragen",
  bezirk_pricing_footnote:
    "* Alle Preise inkl. MwSt. Der exakte Fixpreis wird nach kostenloser Besichtigung festgelegt.",
  bezirk_ablauf_heading_prefix: "So läuft Ihr Umzug in",
  bezirk_ablauf_heading_suffix: "ab",
  bezirk_step1_title: "Kostenlose Anfrage",
  bezirk_step1_text:
    "Kontaktieren Sie uns online oder per Telefon — wir melden uns innerhalb von 60 Minuten.",
  bezirk_step2_title: "Gratis Besichtigung",
  bezirk_step2_text:
    "Wir kommen kostenlos zu Ihnen und erstellen einen verbindlichen Fixpreis vor Ort.",
  bezirk_step3_title: "Planung & Organisation",
  bezirk_step3_text:
    "Wir organisieren alles: Halteverbot, Team, LKW, Verpackungsmaterial.",
  bezirk_step4_title: "Umzugstag",
  bezirk_step4_text:
    "Pünktlich, professionell und vollversichert — wir kümmern uns um alles bis zum letzten Karton.",
  bezirk_comparison_h2: "Fixpreis vs. Stundenlohn — was ist besser?",
  bezirk_comparison_fix_title: "Fixpreis (BAK Transport)",
  bezirk_comparison_fix_1: "Sie wissen vorher genau, was Sie zahlen",
  bezirk_comparison_fix_2: "Kein Risiko bei Verzögerungen",
  bezirk_comparison_fix_3: "Anreiz für das Team, effizient zu arbeiten",
  bezirk_comparison_fix_4: "Keine bösen Überraschungen nach dem Umzug",
  bezirk_comparison_fix_5: "Ideal für Budgetplanung",
  bezirk_comparison_hourly_title: "Stundenlohn (Vorsicht)",
  bezirk_comparison_hourly_1: "Endrechnung oft deutlich höher als erwartet",
  bezirk_comparison_hourly_2: "Kein Anreiz für schnelles Arbeiten",
  bezirk_comparison_hourly_3: "Stau, Parkplatzsuche — alles wird verrechnet",
  bezirk_comparison_hourly_4: "Schwer planbar für Budget",
  bezirk_comparison_hourly_5: "Häufig Streit über geleistete Stunden",
  bezirk_faq_h2_prefix: "Häufige Fragen — Umzug",
  bezirk_other_districts_h3: "Weitere Bezirke in Wien",
  bezirk_cta_h2_prefix: "Jetzt Fixpreis für",
  bezirk_cta_h2_suffix: "anfragen",
  bezirk_cta_desc:
  ...
  location_related_heading: "Passende Leistungen & Ratgeber",
  location_related_privatumzug: "Privatumzug",
  location_related_firmenumzug: "Firmenumzug",
  location_related_moebelmontage: "Möbelmontage",
  location_related_preise: "Preise & Preisrechner",
  location_related_altbau: "Umzug im Altbau",
  bezirk_related_halteverbot: "Halteverbotszone beantragen",
  // NÖ Ort pages
  ...
  // Preisrechner
  rechner_heading: "Preisrechner: Ihre Kostenschätzung in Sekunden",
  rechner_intro: "Wählen Sie Ihre Umzugsart und Größe für eine unverbindliche Preisspanne. Den genauen Fixpreis erhalten Sie nach der kostenlosen Besichtigung.",
  rechner_type_label: "Was möchten Sie umziehen?",
  rechner_type_privat: "Privatumzug",
  rechner_type_firma: "Firmenumzug",
  rechner_type_entruempelung: "Entrümpelung",
  rechner_size_label: "Größe",
  rechner_result_label: "Geschätzte Preisspanne",
  rechner_result_note: "Unverbindliche Schätzung basierend auf unseren Standardpreisen. Der genaue Fixpreis hängt von Stockwerk, Zufahrt und Möbelvolumen ab und wird nach der kostenlosen Besichtigung verbindlich festgelegt.",
  rechner_on_request: "Preis auf Anfrage",
  rechner_cta: "Kostenlose Besichtigung anfragen",
  rechner_privat_1: "bis 40 m² (Studio / 1 Zimmer)",
  rechner_privat_2: "50–70 m² (2 Zimmer)",
  rechner_privat_3: "70–100 m² (3 Zimmer)",
  rechner_privat_4: "100–140 m² (4 Zimmer)",
  rechner_privat_5: "über 140 m² / Haus (5+ Zimmer)",
  rechner_firma_1: "Büro bis 100 m²",
  rechner_firma_2: "Büro 100–300 m²",
  rechner_firma_3: "Büro über 300 m²",
  rechner_entruempelung_1: "Keller, Abstellraum oder wenige Möbelstücke",
  rechner_entruempelung_2: "Wohnung bis 50 m²",
  rechner_entruempelung_3: "Haus, Büro, Verlassenschaft oder Gewerbefläche",
...
const en: typeof de = {
  ...
  datenschutz_responsible_a:
    "The data processing on this website is carried out by the website operator: BAK Transport, Zwinzstraße 15-21, 1160 Vienna, office@baktransport.at",
  ...
  datenschutz_contact:
    "BAK Transport · Zwinzstraße 15-21, 1160 Vienna · office@baktransport.at · +43 681 10723047",
  ...
  // Bezirk
  bezirk_wien: "Vienna",
  bezirk_label_prefix: "Moving",
  bezirk_subtitle_prefix: "Your professional moving partner in",
  bezirk_subtitle_suffix: "— fixed price, fully insured, reliable.",
  bezirk_intro_h2_prefix: "Professional Moving Service in",
  bezirk_intro_p2:
  ...
  bezirk_checklist_3: "Protective blankets & packing materials",
  bezirk_checklist_4: "Furniture disassembly & assembly on request",
  bezirk_checklist_5: "No-parking zone organization",
  bezirk_checklist_6: "Full liability insurance",
  bezirk_checklist_7: "Free on-site inspection in advance",
  bezirk_checklist_8: "Binding fixed price – no surprises",
  bezirk_pricing_h2_prefix: "Moving Prices for",
  bezirk_pricing_subtitle:
    "Fixed prices after inspection — no hourly-rate trap, no hidden costs.",
  bezirk_price1_label: "Small",
  bezirk_price1_size: "up to 50 m²",
  bezirk_price1_price: "from €650",
  bezirk_price1_detail: "1–2 rooms, incl. 2 movers & truck",
  bezirk_price2_label: "Compact",
  bezirk_price2_size: "50–90 m²",
  bezirk_price2_price: "from €950",
  bezirk_price2_detail: "2–3 rooms, incl. 3 movers & truck",
  bezirk_price3_label: "Large",
  bezirk_price3_size: "over 90 m²",
  bezirk_price3_price: "from €1,490",
  bezirk_price3_detail: "4+ rooms, incl. 4 movers & truck",
  bezirk_pricing_cta_btn: "Request Fixed Price Now",
  bezirk_pricing_footnote:
    "* All prices incl. VAT. The exact fixed price is determined after a free inspection.",
  bezirk_ablauf_heading_prefix: "How Your Move in",
  bezirk_ablauf_heading_suffix: "Works",
  bezirk_step1_title: "Free Inquiry",
  bezirk_step1_text:
    "Contact us online or by phone — we'll get back to you within 60 minutes.",
  bezirk_step2_title: "Free Inspection",
  bezirk_step2_text:
    "We come to you free of charge and put together a binding fixed price on site.",
  bezirk_step3_title: "Planning & Organization",
  bezirk_step3_text:
    "We organize everything: no-parking zone, team, truck, packing materials.",
  bezirk_step4_title: "Moving Day",
  bezirk_step4_text:
    "Punctual, professional, and fully insured — we take care of everything down to the last box.",
  bezirk_comparison_h2: "Fixed Price vs. Hourly Rate — Which Is Better?",
  bezirk_comparison_fix_title: "Fixed Price (BAK Transport)",
  bezirk_comparison_fix_1: "You know exactly what you'll pay in advance",
  bezirk_comparison_fix_2: "No risk in case of delays",
  bezirk_comparison_fix_3: "Incentive for the team to work efficiently",
  bezirk_comparison_fix_4: "No nasty surprises after the move",
  bezirk_comparison_fix_5: "Ideal for budget planning",
  bezirk_comparison_hourly_title: "Hourly Rate (Caution)",
  bezirk_comparison_hourly_1: "Final bill often significantly higher than expected",
  bezirk_comparison_hourly_2: "No incentive to work quickly",
  bezirk_comparison_hourly_3: "Traffic jams, searching for parking — everything gets billed",
  bezirk_comparison_hourly_4: "Hard to plan for your budget",
  bezirk_comparison_hourly_5: "Frequent disputes over hours worked",
  bezirk_faq_h2_prefix: "Frequently Asked Questions — Moving",
  bezirk_other_districts_h3: "Other Districts in Vienna",
  bezirk_cta_h2_prefix: "Request Your Fixed Price for",
  bezirk_cta_h2_suffix: "Now",
  bezirk_cta_desc:
  ...
  location_related_heading: "Related Services & Guides",
  location_related_privatumzug: "Private Move",
  location_related_firmenumzug: "Office Move",
  location_related_moebelmontage: "Furniture Assembly",
  location_related_preise: "Prices & Price Calculator",
  location_related_altbau: "Moving in a Prewar Building",
  bezirk_related_halteverbot: "Apply for a No-Parking Zone",
  ...
  // Price Calculator
  rechner_heading: "Price Calculator: Your Estimate in Seconds",
  rechner_intro: "Choose your move type and size for a non-binding price range. You'll receive the exact fixed price after a free on-site inspection.",
  rechner_type_label: "What would you like to move?",
  rechner_type_privat: "Private Move",
  rechner_type_firma: "Office Move",
  rechner_type_entruempelung: "Clearance",
  rechner_size_label: "Size",
  rechner_result_label: "Estimated Price Range",
  rechner_result_note: "Non-binding estimate based on our standard prices. The exact fixed price depends on floor level, access, and furniture volume, and is set in binding form after a free inspection.",
  rechner_on_request: "Price on request",
  rechner_cta: "Request a Free Inspection",
  rechner_privat_1: "up to 40 m² (studio / 1 room)",
  rechner_privat_2: "50–70 m² (2 rooms)",
  rechner_privat_3: "70–100 m² (3 rooms)",
  rechner_privat_4: "100–140 m² (4 rooms)",
  rechner_privat_5: "over 140 m² / house (5+ rooms)",
  rechner_firma_1: "Office up to 100 m²",
  rechner_firma_2: "Office 100–300 m²",
  rechner_firma_3: "Office over 300 m²",
  rechner_entruempelung_1: "Basement, storage room, or a few furniture items",
  rechner_entruempelung_2: "Apartment up to 50 m²",
  rechner_entruempelung_3: "House, office, estate, or commercial space",
